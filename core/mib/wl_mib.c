...
extern BOOLEAN mib_InitAp(MIB_802DOT11 * mib, char *addr, int phyMacId, int vMacId, int shadow)
{
	...
	util_CopyList(mib_StaCfg->DesiredSsId, OEMSSID, IEEEtypes_SSID_SIZE);
	...
	*(mib->mib_amsdu_maxsize ) = 1600;
	*(mib->mib_amsdu_allowsize) = 1360;
