...
#ifdef QUEUE_STATS
#define HostCmd_CMD_GET_QUEUE_STATS         0x1156
#define HostCmd_CMD_RESET_QUEUE_STATS       0x1157
#define HostCmd_CMD_QSTATS_SET_SA           0x1158
#endif
...
typedef PACK_START struct _rate_hist_t
{
    ...
    UINT32  HtRates[2][2][QS_NUM_SUPPORTED_MCS];
...
typedef PACK_START struct tagHostCmd_FW_GET_RATETABLE
{
	...
	UINT8       Addr[6]; 
	#ifdef SOC_W8764
	UINT32      SortedRatesIndexMap[RATE_TBL_SIZE];
	#else
	UINT16      SortedRatesIndexMap[RATE_TBL_SIZE];
	#endif
