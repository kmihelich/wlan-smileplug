...
#define AP8X_VER_H_
    ...
    #define FEATURE_SUFFIX
   	#define SOC_SUFFIX	"-W8366-GPL"
#elif defined(SOC_W8364)
	#define FEATURE_SUFFIX
   	#define SOC_SUFFIX	"-W8364-GPL"
#elif defined(SOC_W8764)
	#define FEATURE_SUFFIX
   	#define SOC_SUFFIX	"-W8764-GPL"
#else
...
#define DRV_VERSION   "6.2.0.2" SOC_SUFFIX OS_SUFFIX PLATFORM_SUFFIX FEATURE_SUFFIX
